...
namespace Annelitrice
{
 ...
 //       }
	...
	//		DoMinusButton(ref point, ref compEvolution.redBilePoints, "Anneli.Red".Translate(), Textures.Red_Minus, Textures.Red_Minus_Hovering);
	//		DoPlusButton(ref point, ref compEvolution.redBilePoints, "Anneli.Red".Translate(), Textures.Red_Plus, Textures.Red_Plus_Hovering);
			
	//		DoMinusButton(ref point, ref compEvolution.greenBilePoints, "Anneli.Green".Translate(), Textures.Green_Minus, Textures.Green_Minus_Hovering);
	//		DoPlusButton(ref point, ref compEvolution.greenBilePoints, "Anneli.Green".Translate(), Textures.Green_Plus, Textures.Green_Plus_Hovering);
			
	//		DoMinusButton(ref point, ref compEvolution.blueBilePoints, "Anneli.Blue".Translate(), Textures.Blue_Minus, Textures.Blue_Minus_Hovering);
	//		DoPlusButton(ref point, ref compEvolution.blueBilePoints, "Anneli.Blue".Translate(), Textures.Blue_Plus, Textures.Blue_Plus_Hovering);
 ...
 //           }
	//		TooltipHandler.TipRegion(healRect, "Anneli.HealTooltip".Translate(CompEvolution.HealingCost));
	//		if (healRect.IsLeftClicked())
 //           {
	//			if (compEvolution.evolutionPoints < CompEvolution.HealingCost)
 //               {
	//				Messages.Message("Anneli.NotEnoughEPs".Translate(), pawn, MessageTypeDefOf.CautionInput);
	//			}
	//			else
 //               {
 ...
 //                   }
	...
	//		Widgets.Label(evolutionPointsRect, "Anneli.EPs".Translate() + ": " + compEvolution.evolutionPoints.ToString());
 ...
 //               {
	//				Messages.Message("Anneli.BodyPartIsMissing".Translate(), pawn, MessageTypeDefOf.CautionInput);
	//			}
	//		}
	//	}
 ...
 //           {
	...
	//		}
	//		TooltipHandler.TipRegion(bileMinusButton, "Anneli.MinusSignTooltip".Translate(colorName, CompEvolution.BilePointCost));

	//		if (bileMinusButton.IsLeftClicked())
	//		{
	//			if (bilePointField <= 0)
	//			{
	//				Messages.Message("Anneli.NoBilePoints".Translate(colorName), pawn, MessageTypeDefOf.CautionInput);
	//			}
	//			else
	//			{
	//				bilePointField -= 1;
 ...
 //           {
	...
	//		}
	//		TooltipHandler.TipRegion(bilePlusButton, "Anneli.PlusSignTooltip".Translate(CompEvolution.BilePointCost, colorName));

	//		if (bilePlusButton.IsLeftClicked())
	//		{
	//			if (bilePointField == CompEvolution.MaxBilePoints)
	//			{
	//				Messages.Message("Anneli.MaxBilePoints".Translate(colorName), pawn, MessageTypeDefOf.CautionInput);
	//			}
