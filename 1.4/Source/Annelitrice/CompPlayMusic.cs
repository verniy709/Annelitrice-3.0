...
namespace Annelitrice
{
    ...
    public class CompPlayMusic : ThingComp
    {
        ...
        public override IEnumerable<Gizmo> CompGetWornGizmosExtra()
        {
            ...
            {
                defaultLabel = "Anneli.PlaySong".Translate(GetSongName(curSoundDef)),
                defaultDesc = "Anneli.PlaySongDesc".Translate(),
            ...
            yield return new Command_Action()
            {
                defaultLabel = "Anneli.StopSong".Translate(),
                defaultDesc = "Anneli.StopSongDesc".Translate(),
            ...
            yield return new Command_Action()
            {
                defaultLabel = "Anneli.SelectSong".Translate(),
                defaultDesc = "Anneli.SelectSongDesc".Translate(),
