...
namespace Annelitrice
{
    ...
    public static class Textures
    {
        ...
        //    leftArmAppendages[AnnelitriceDefOf.Anneli_BoneBlade] = Arm_Left_BoneBlade_UI;
        //    leftArmAppendages[AnnelitriceDefOf.Anneli_BoneSpike] = Arm_Left_BoneSpike_UI;
        //    leftArmAppendages[AnnelitriceDefOf.Anneli_CrushingArm] = Arm_Left_CrushingArm_UI;
        //    leftArmAppendages[AnnelitriceDefOf.Anneli_Tentacle] = Arm_Left_Tentacle_UI;
        //    leftPairedAppendanges[BodyPartDefOf.Arm] = leftArmAppendages;
        //
        //    var leftLegAppendages = new Dictionary<HediffDef, Texture2D>();
        //    leftLegAppendages[AnnelitriceDefOf.Anneli_Arachno] = Leg_Left_Arachno_UI;
        //    leftLegAppendages[AnnelitriceDefOf.Anneli_DollJoint] = Leg_Left_DollJoint_UI;
        //    leftLegAppendages[AnnelitriceDefOf.Anneli_Lumps] = Leg_Left_Lumps_UI;
        //    leftLegAppendages[AnnelitriceDefOf.Anneli_VenomGland] = Leg_Left_VenomGland_UI;
        //    leftPairedAppendanges[BodyPartDefOf.Leg] = leftLegAppendages;
        //
        //    var rightArmAppendages = new Dictionary<HediffDef, Texture2D>();
        //    rightArmAppendages[AnnelitriceDefOf.Anneli_BoneBlade] = Arm_Right_BoneBlade_UI;
        //    rightArmAppendages[AnnelitriceDefOf.Anneli_BoneSpike] = Arm_Right_BoneSpike_UI;
        //    rightArmAppendages[AnnelitriceDefOf.Anneli_CrushingArm] = Arm_Right_CrushingArm_UI;
        //    rightArmAppendages[AnnelitriceDefOf.Anneli_Tentacle] = Arm_Right_Tentacle_UI;
        //    rightPairedAppendanges[BodyPartDefOf.Arm] = rightArmAppendages;
        //
        //    var rightLegAppendages = new Dictionary<HediffDef, Texture2D>();
        //    rightLegAppendages[AnnelitriceDefOf.Anneli_Arachno] = Leg_Right_Arachno_UI;
        //    rightLegAppendages[AnnelitriceDefOf.Anneli_DollJoint] = Leg_Right_DollJoint_UI;
        //    rightLegAppendages[AnnelitriceDefOf.Anneli_Lumps] = Leg_Right_Lumps_UI;
        //    rightLegAppendages[AnnelitriceDefOf.Anneli_VenomGland] = Leg_Right_VenomGland_UI;
        //    rightPairedAppendanges[BodyPartDefOf.Leg] = rightLegAppendages;
        //
        //    var backAppendages = new Dictionary<HediffDef, Texture2D>();
        //    backAppendages[AnnelitriceDefOf.Anneli_BoneWing] = Back_BoneWing_UI;
        //    backAppendages[AnnelitriceDefOf.Anneli_Lump] = Back_Lump_UI;
        //    backAppendages[AnnelitriceDefOf.Anneli_PatagiumWing] = Back_PatagiumWing_UI;
        //    backAppendages[AnnelitriceDefOf.Anneli_BackTentacle] = Back_Tentacle_UI;
        //    pairedAppendanges[AnnelitriceDefOf.Spine] = backAppendages;
        //
        //    var headAppendages = new Dictionary<HediffDef, Texture2D>();
        //    headAppendages[AnnelitriceDefOf.Anneli_Kuchisake] = Head_Kuchisake_UI;
        //    headAppendages[AnnelitriceDefOf.Anneli_Piercing] = Head_Piercing_UI;
        //    headAppendages[AnnelitriceDefOf.Anneli_ProliferatingBrain] = Head_ProliferatingBrain_UI;
        //    headAppendages[AnnelitriceDefOf.Anneli_ThirdEye] = Head_ThirdEye_UI;
        //    pairedAppendanges[BodyPartDefOf.Head] = headAppendages;
        //
        //    var peritoneumAppendages = new Dictionary<HediffDef, Texture2D>();
        //    peritoneumAppendages[AnnelitriceDefOf.Anneli_Banelings] = Torso_Banelings_UI;
        //    peritoneumAppendages[AnnelitriceDefOf.Anneli_Boomalope] = Torso_Boomalope_UI;
        //    peritoneumAppendages[AnnelitriceDefOf.Anneli_GastrovascularCavity] = Torso_GastrovascularCavity_UI;
        //    peritoneumAppendages[AnnelitriceDefOf.Anneli_Piercing] = Torso_Piercing_UI;
